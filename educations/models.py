...
class EducationPlanPointList(models.Model):
    text = models.CharField(max_length=256, blank=True, null=True, default=None)
    education_plan = models.ForeignKey(EducationPlanPoint, on_delete=models.CASCADE, blank=True, null=True, default=None)
    order = models.IntegerField(default=0)
    is_active = models.BooleanField(default=True)
    created = models.DateTimeField(auto_now_add=True , auto_now=False)
    updated = models.DateTimeField(auto_now_add=False , auto_now=True)
